...
#mappluto2015bx=mappluto2015bx[['BBL','APPBBL','XCoord','YCoord','geometry']].reset_index(drop=True)
...
#mappluto2015bx=mappluto2015bx[['BBL','APPBBL','Latitude','Longitude','geometry']].reset_index(drop=True)
...
#mappluto2015bk=mappluto2015bk[['BBL','APPBBL','XCoord','YCoord','geometry']].reset_index(drop=True)
...
#mappluto2015bk=mappluto2015bk[['BBL','APPBBL','Latitude','Longitude','geometry']].reset_index(drop=True)
...
#mappluto2015mn=mappluto2015mn[['BBL','APPBBL','XCoord','YCoord','geometry']].reset_index(drop=True)
...
#mappluto2015mn=mappluto2015mn[['BBL','APPBBL','Latitude','Longitude','geometry']].reset_index(drop=True)
...
#mappluto2015qn=mappluto2015qn[['BBL','APPBBL','XCoord','YCoord','geometry']].reset_index(drop=True)
...
#mappluto2015qn=mappluto2015qn[['BBL','APPBBL','Latitude','Longitude','geometry']].reset_index(drop=True)
...
#mappluto2015si=mappluto2015si[['BBL','APPBBL','XCoord','YCoord','geometry']].reset_index(drop=True)
...
#mappluto2015si=mappluto2015si[['BBL','APPBBL','Latitude','Longitude','geometry']].reset_index(drop=True)
